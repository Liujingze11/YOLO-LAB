...
启动：python linux/entry.py  或  cd linux && python entry.py
"""
...
# Also add linux/ root so root-level modules are importable
_LINUX_ROOT = str(ROOT.parent)
if _LINUX_ROOT not in sys.path:
    sys.path.insert(0, _LINUX_ROOT)
